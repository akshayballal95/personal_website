...
- **BE Mechanical Engineering**, Birla Institute of Technology, Mesra, India, 2013–2017. Part of Firebolt Racing (student Baja team), where I designed and manufactured 3 cars over 3 years as Chassis Designer and Vehicle Integration Head.
...
4. **Pulsar** (github.com/akshayballal95/Pulsar): Cursor-like web IDE for knowledge work. File explorer, Monaco editor with markdown/PDF preview, and streaming AI agent chat with visible tool calls and diffs. Agent Skills, Slack/Telegram integrations, persistent sandboxes on AWS. Live at pulsarbot.cloud.
5. **Ajna DrawSense** (github.com/akshayballal95/ajna-app): AI-powered engineering drawing analysis platform. LangGraph + Gemini pipeline with YOLO detection extracts dimensions, tolerances, and machine fit checks from PDF/image drawings. React frontend + FastAPI backend on AWS Lambda. Live at takshaai.triviz.cloud.
